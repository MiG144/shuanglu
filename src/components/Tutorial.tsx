...
const STEPS = [
  ...
  },
  {
    ...
    body: (
      <>
        <ul>
          <li><b>看颜色点马</b>：<strong>橙色脉冲</strong> = 本回合可走的己方马；点它选中</li>
          <li><b>走子</b>：选中后再点<strong>黄色闪光</strong>的目标梁完成移动（也可直接<b>拖拽</b>马过去）</li>
          <li><b>拈出</b>：<strong>绿色</strong>格可拈出，点击后<b>再点一次</b>（或拖到自身外）离盘</li>
          <li><b>入局</b>：黄色闪烁落点可直接点击入场</li>
          <li>点错位置或点到对方的马，会弹出<b>提示条</b>告诉你原因，不会没反应</li>
          <li>无合法走子会自动跳过；<b>悔棋</b>、<b>复盘</b>、<b>存档</b>在顶栏</li>
        </ul>
      </>
    ),
  },
